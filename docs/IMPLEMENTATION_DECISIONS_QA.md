...
### Q55. What fields should `NormalizedQuery` contain?

**Recommended Answer**  
`NormalizedQuery` should contain:
...
**Why**  
This keeps the semantic layer open-ended and LLM-driven without hardcoding medical concepts such as modifiers, acceptable diseases, or special-case population fields.

### Q56. What fields should `EvidencePlan` and `SpecialistTask` contain?

**Recommended Answer**  
`EvidencePlan` should contain:
...
**Why**  
The LLM should plan the evidence gathering explicitly, and connectors should consume source queries generated by that semantic layer rather than connector-side heuristics.
